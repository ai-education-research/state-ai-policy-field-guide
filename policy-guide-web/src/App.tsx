...
function App() {
  ...
  return <div><Header route={route}/><main id="main" className="site-main">{view}</main><StayCurrent/><footer className="site-footer"><div><b>What Students Learned About AI Before College</b><p>Research current through July 2026. Legislative status and living guidance can change.</p></div><div className="footer-right"><p className="byline">Research and site by <a href="https://sidsresearchcommunity.com" target="_blank" rel="noreferrer">Sidaard Gunasekaran</a><span>Associate Professor, University of Dayton</span></p><p className="ai-disclosure">This site was researched, written, and built with Claude (Anthropic) under my direction. All claims were verified against primary documents. I set the argument, directed the research, and made every editorial decision.</p><button onClick={()=>routeTo('methodology')}>Methodology and evidence</button></div></footer></div>
}
